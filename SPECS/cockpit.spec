...
%changelog
* Thu Jan 25 2024 Release Engineering <releng@openela.org> - 286.2
- Remove recommends on subscription-manager-cockpit if applicable

* Tue May 16 2023 Martin Pitt <mpitt@redhat.com> - 286.2-1
- storage: When fixing NBDE, also recognize indirect root filesystems (rhbz#2207498)
